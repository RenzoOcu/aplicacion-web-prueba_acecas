...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <!-- palabras logo de unision session -->
            <a href="<?php echo $ruta; ?>/index2.html"><b>bienvenido</b> </a>
        </div>

        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">inicia sesion mi estimado </p>
                <form method="post" id="formulariologin">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                        <!-- boton que tiene que llamar a la categoria ojo  -->    
